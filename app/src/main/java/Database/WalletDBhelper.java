...
public class WalletDBhelper extends SQLiteOpenHelper {
    ...
    public ArrayList<AddExpense> readAllExpense() {
        ...
        Cursor values = db.query(WalletUserMaster.Addexpences.TABLE_NAME_ADDEXPENCES, projection, null, null,
                null, null, sortOrder);
    ...
    //expensess category update part
    ...
    public boolean incomeEditAccount(String id, String incomeacount, String incomeamount) {
        SQLiteDatabase db = getReadableDatabase();

        ContentValues contentValues = new ContentValues();
        contentValues.put(WalletUserMaster.AddIncomeAcountCategory.COLUME_NAME_INCOME_ACOUNT_TYPE, incomeacount);
        contentValues.put(WalletUserMaster.AddIncomeAcountCategory.COLUME_NAME_INCOME_AMOUNT, incomeamount);

        String Selection = WalletUserMaster.AddIncomeAcountCategory._ID;
        String SelectionArge[] = {id};

        int r = db.update(WalletUserMaster.AddIncomeAcountCategory.TABLE_NAME_INCOME_ACCOUNT, contentValues, Selection, SelectionArge);
    ...
    public void deleteIncomeAcount(int id){
        SQLiteDatabase db = getReadableDatabase();
        String Selection = WalletUserMaster.AddIncomeAcountCategory._ID + " =? ";
        String[] SelectionArge ={String.valueOf(id)};

        db.delete(WalletUserMaster.AddIncomeAcountCategory.TABLE_NAME_INCOME_ACCOUNT,Selection,SelectionArge);
        Log.i("DB", "Delete :" + id);
    }
